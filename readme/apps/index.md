...
- **[Outlining and Nested Lists](https://github.com/laurent22/joplin/blob/dev/readme/apps/outlining.md)** - Create hierarchical outlines similar to Workflowy using nested lists and keyboard shortcuts
- **[To-dos and Task Management](https://github.com/laurent22/joplin/blob/dev/readme/apps/to-dos.md)** - Manage tasks with checkboxes and due dates
- **[Markdown Guide](https://github.com/laurent22/joplin/blob/dev/readme/apps/markdown.md)** - Learn how to format your notes with Markdown
